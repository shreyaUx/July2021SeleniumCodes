...
public class ElementUtil {
	...
	public void doSendKeys(By locator, String value) {
     ...
     public int doSendKeys(By locator , int value) {
	...
	public WebElement waitForElementPresenceWithWebDriverWait(By locator, int timeOut, int pollingTime) {
		WebDriverWait wait = new WebDriverWait(driver, timeOut);
		wait.withMessage(ErrorClass.TIME_OUT_WEB_ELEMENT_MESG).pollingEvery(Duration.ofMillis(pollingTime))
	...
	public WebElement waitForElementPresenceWithFluetWait(By locator, int timeOut, int pollingTime) {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(timeOut))
				.withMessage(ErrorClass.TIME_OUT_WEB_ELEMENT_MESG).pollingEvery(Duration.ofMillis(pollingTime))
				.ignoring(StaleElementReferenceException.class, NoSuchElementException.class);
	...
	public Alert waitForAlertPresenceWithFluetWait(int timeOut, int pollingTime) {
		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(timeOut))
				.withMessage(ErrorClass.TIME_OUT_ALERT_MESG).pollingEvery(Duration.ofMillis(pollingTime))
...
//		Wait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(Duration.ofSeconds(timeOut))
//				.withMessage(ErrorClass.TIME_OUT_FRAME_MESG).pollingEvery(Duration.ofMillis(pollingTime))
